  ...
  return (
    ...
    <div className="flex justify-center p-12 gap-8 w-4/5">
      ...
      <div className="flex flex-col gap-y-1 ml-10">
        ...
        <button className="w-full p-2 bg-[var(--warning)] rounded-xl text-white font-semibold px-12 mt-5 hover:bg-[#f6aa1cc7] hover:text-warning border border-warning">Comprar</button>
      </div>
    </div>
